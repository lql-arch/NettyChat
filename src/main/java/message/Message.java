...
//    }
    ...
    public static final int ShowMessage = 18;
    public static final int IdleMessage = 19;
    ...
    static {
        ...
        map.put(ShowMessage,ShowMessage.class);
        map.put(IdleMessage,IdleMessage.class);
    }
